...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '83caa7b5183148ae86daaec2af452e18',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zevZhang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的码农', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zevzhang.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'zevZhang, 博客', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/3546587290667830?spm_id_from=333.1007.0.0', // B站主页
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '3073269584', // 对应歌单的 id
